...
#This is called by app.py, it contains the logic for what should be deployed in one CF stack
...
# kwargs: the last (sometimes optional) arguments is always a set of initialization arguments. Those are specific to each construct. For example, the lambda.Function construct accepts arguments like runtime, code and handler. You can explore the various options using your IDE’s auto-complete or in the online documentation.
...
class CdkworkshopStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, construct_id: str, **kwargs) -> None:
        ...
        # https://docs.aws.amazon.com/cdk/api/latest/python/aws_cdk.aws_lambda.html
        ...
        # Define a resource using a custom construct (imported above using .hitcounter)
        # include a parameter "downstream" which is the my_lambda function above
